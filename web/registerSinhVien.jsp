...
<head>
  <meta charset="UTF-8">
  <title>Đăng ký Sinh viên - N5</title>
    ...
    <div class="row w-100">
      ...
      <div class="col-md-5 d-flex align-items-center justify-content-center">
        <div class="register-box w-100 mx-3">
          ...
          <h4 class="text-primary fw-semibold text-center mb-3">Đăng ký Sinh viên</h4>
          ...
          <form action="register" method="post" id="registerForm">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="MaSV" name="MaSV" placeholder="VD: SV001" maxlength="10" required>
            </div>
            <div class="mb-3">
              <label for="HoTen" class="form-label">Họ và tên</label>
              <input type="text" class="form-control" id="HoTen" name="HoTen" placeholder="VD: Nguyễn Văn A" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="tel" class="form-control" id="SDT" name="SDT" placeholder="VD: 0123456789" maxlength="10" pattern="0\d{9}" title="Số điện thoại hợp lệ gồm 10 chữ số bắt đầu bằng 0" required>
            </div>
            <div class="mb-3">
              <label for="DiaChi" class="form-label">Địa chỉ</label>
              <input type="text" class="form-control" id="DiaChi" name="DiaChi" placeholder="VD: 123 Đường Láng, Hà Nội">
            </div>
            <div class="mb-3">
              <label for="LopHC" class="form-label">Lớp hành chính</label>
              <input type="text" class="form-control" id="LopHC" name="LopHC">
            </div>
            <div class="mb-3">
              <label for="TinhTrang" class="form-label">Tình trạng</label>
              <select class="form-control" id="TinhTrang" name="TinhTrang" required>
                <option value="" hidden selected>-- Tình trạng --</option>
